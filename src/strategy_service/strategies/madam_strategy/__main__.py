"""
Test module for Madam Strategy (Support/Resistance)
Run with: python -m src.strategy_service.strategies.madam_strategy test
"""
...
def run_test():
    """Test the Support Resistance Strategy"""
    print("Testing Madam Strategy (Support/Resistance)")
    print("=" * 60)
    ...
    try:
        ...
        print("\n" + "=" * 60)
        print("✅ Madam Strategy test completed successfully!")
        return True
...
if __name__ == "__main__":
    if len(sys.argv) > 1 and sys.argv[1] == "test":
        ...
        print("Madam Strategy (Support/Resistance)")
        print("Run with 'test' argument to test:")
        print("  python -m src.strategy_service.strategies.madam_strategy test")
